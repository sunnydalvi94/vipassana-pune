...
class Ourcenters_api extends Base_Controller 
{
	...
	*/	
     public function validationOurcentersDetails($details,$flag)
     {
        ...
        $this->form_validation->set_rules('our_center_name','our_center_name',array('required','min_length[3]','max_length[30]',"regex_match[/^([A-Za-z][A-Za-z\,\(\)\-\_\'\"\:\;\&\|\s]{2,29})$/]"),
		array(
			'required'=>'Name is Required',
			'min_length'=>'Min 3 Character Required.',
			'max_length'=>'Max 30 Character Allowed.',
