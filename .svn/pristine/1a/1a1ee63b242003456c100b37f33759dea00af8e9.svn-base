...
<head>
    <meta charset="utf-8" />
    <title>One Day Vipassana Courses | Vipassana </title>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="c-content-title-2">
              <h3 class="c-center" style=";margin-bottom: 15px;">One Day Vipassana Courses</h3>
        ...
        <div class="table2">
          <div class="c-content-tab-4 c-opt-3 tab_content" role="tabpanel" class=" ">
            <ul class="nav nav-justified" role="tablist">
              <li role="presentation"  id="tab_id">
                                  ...
                                  <td>
                                    <div class="zoom-in">
                                      <div  class="text c-theme-on-hover" style="cursor: pointer;"><b style="text-align: center;">View</b></div>
                                        <div class="overlay">
                                        <img style="height: 134px;width: 240px;cursor: pointer;" src="<?php echo base_url(); ?>uploads/one_day_course_images/<?php echo (isset($key->one_day_course_image) && !empty($key->one_day_course_image))?$key->one_day_course_image:'default.png';?>"  alt="Avatar" class="image">
                                      </div>
                                    </div>
                                  <td>
              ...
              <div  class="row">
                ...
                <div class="col-md-1">
                  ...
                  <div class="zoom-in" style="z-index: 1">
                      <p class="text c-theme-on-hover" style="cursor: pointer;"><b>View</b></p>
                      <div class="overlay">
                      <img style="height: 134px;width: 240px;cursor: pointer;" src="<?php echo base_url(); ?>uploads/one_day_course_images/<?php echo (isset($key->one_day_course_image) && !empty($key->one_day_course_image))?$key->one_day_course_image:'default.png';?>"  alt="Avatar" class="image">
                      </div>
                  </div>
