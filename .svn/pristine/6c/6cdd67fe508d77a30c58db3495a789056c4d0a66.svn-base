...
<html lang="en"  >
    ...
    <head>
    	<meta charset="utf-8"/>
    	<title>Dhamma Punna | Vipassana</title>
    ...
    <body class="c-layout-header-fixed c-layout-header-mobile-fixed " >
               ...
               <div id="feature-14-1" class="c-content-feature-14 c-bg-white" style="padding:40px 0px;overflow:hidden">
                    <div class="container">
                        <div class="c-content-title-2">
                            <h3 class="c-center" style="font-size:22px;">Dhamma Punna Vipassana Center in Pune City</h3>
                                ...
                                <div class="c-content-box c-bg-parallax">
                                    <div class="c-content-testimonials-1" data-slider="owl">
                                        <div class="owl-carousel owl-theme c-theme c-owl-nav-center" data-single-item="true" data-slide-speed="5000" data-rtl="false"> 
                                            <?php if(isset($dhamma_punna_data) && !empty($dhamma_punna_data))
                                            {
                                             $i=1;
                                                foreach ($dhamma_punna_data as $key) 
                                                {
                                                 ?>
                                                <div class="item">
                        ...
                        <section>
                            <div class="c-content-box c-size-md 1 about_center" style="padding:30px 0px 0px 0px;">
                                ...
                                <div class="c-address"style="line-height:27px;">
                                    <table>
                                        ...
                                        <tr> <td> <i class="icon-envelope c-font-blue-2">&nbsp;</i> </td>   
                                            <td>
                                            E-Mail&nbsp;:&nbsp;info.dhammapunna@vridhamma.org
                                            </td>
                                        </tr>
                                    </table> 
                                    <br> 
    	...
    	<script src="<?php echo base_url(); ?>assets/site/demos/default/js/scripts/revo-slider/slider-1.js" type="text/javascript"></script>
