...
<head>
	<meta charset="utf-8"/>
	<title>Add Sliders | Vipassana </title>
					...
					<div class="portlet light" style="padding: 15px 30px 15px 30px;">
						<div class="portlet-title">
							<div class="caption font-blue">
                                ...
                                <span class="caption-subject bold uppercase">Add Sliders</span>
                            </div>
						</div>
						<div class="portlet-body form">
							<form action="children-slider" id="children-slider" data-apikey="<?php echo (isset($keydata->key) && !empty($keydata->key))?$keydata->key:''; ?>" data-redirect="sliders" class="horizontal-form" method="post" enctype="multipart/form-data">
							  	<div class="form-body">
								    <div class="row"> 
								    	<div class="col-md-8">
								    		<div class="row">
									    		<div class="col-md-6">
										    		<div class="form-group">
		                                                <p class="control-label">Slider Type<span class="require" aria-required="true" style="color:red"><small>*</small></span></p>
		                                                <div class="input-icon right"><i class="fa"></i>
		                                            	<select class="form-control select2" name="slider_type_id" id="slider_type"  style="padding-left: 0px;" required>
										        ...
										        <div class="col-md-6">
										        	<div class="form-group">
										    			<p class="control-label">Slider Name</p>
										    			<div class="input-icon right"><i class="fa"></i>
										    				...
										    				placeholder="Slider Name" maxlength="50" >
										    			</div>
										    		</div>
										        </div>
										        <div class="col-md-12">
										        	<div class="form-group">
										    			<p class="control-label"> Slider Description</span></p>
										    			<div class="input-icon right"><i class="fa"></i>
										    				<textarea class="form-control" 
										    				name="slider_description" rows="2" 
										    				placeholder="Slider Description"><?php echo(isset($children_slider_data->slider_description) && !empty($children_slider_data->slider_description))?$children_slider_data->slider_description:'';?></textarea>
										    			</div>
										    		</div>
										        </div>
										       <!--  <div class="col-md-6">
										        	<div class="form-group">
										    			<p class="control-label">Image Title</p>
										    			<div class="input-icon right"><i class="fa"></i>
										    				<input type="text" class="form-control" 
										    				name="image" value="<?php echo(isset($children_slider_data->image) && !empty($children_slider_data->image))?$children_slider_data->image:'';?>"
								    	...
								    	<div class="col-md-4 text-center">
											<div class="form-group">
												<div class="input-icon right"><i class="fa"></i>
										        <p class="control-label bold input-icon right" required>Upload Image<i class="fa"></i><span class="require" aria-required="true" style="color:red"><small>*</small></span></p>
										        </div>
										        <div class="uploaded_image" style="padding-bottom: 10px !important;">
										            <img src="<?php echo base_url(); ?>uploads/children_slider_images/<?php echo(isset($children_slider_data->image) && !empty($children_slider_data->image))?$children_slider_data->image:'default.png';?>" style="height: 150px; width: 200px;" class="img-thumbnail" required/>
										        </div>
