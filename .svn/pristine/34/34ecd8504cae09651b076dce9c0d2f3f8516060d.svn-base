				...
				<div class="row">
					...
					<div class="col-md-5 c-margin-b-20">
						<form name="login-form" class="">
					    	<div class="c-content-media-1 " style="margin-top: 40px; margin-bottom: 350px;" >
								<div class="c-content-title-3 c-title-md c-center" style="border:none; padding-left: 0px;">
									<p><i class="fa fa-exclamation-triangle fa-2x c-font-red"></i></p>
									<h3 class="c-font-red c-font-uppercase c-font-bold">Your Payment Failed</h3>
								</div>
								<div>
									<p class="c-center c-text">
										Please try again
									</p>
								</div><br>
								<div class="row" style="margin-left:-5px;">
									<div class="form-group  col-md-3 pull-right mt-10" style="">
										<button type="submit" class="btn btn-primary btn-xs">
											<a style="color: white;" href="#"><small>Back</small></a>
										</button>
									</div>
								</div>	
							</div>
