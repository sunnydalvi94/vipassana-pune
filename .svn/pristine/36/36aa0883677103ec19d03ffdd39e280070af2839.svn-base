...
<head>
<meta charset="utf-8"/>
	<title>Payment successful | Vipassana</title>
    ...
    <link href="<?php echo base_url(); ?>assets/site/css/jquery.toast.css" rel="stylesheet" type="text/css">
     <!-- .................................payment section style links...................................................... -->
    <link href="<?php echo base_url(); ?>assets/site/css/payment_section.css" rel="stylesheet" type="text/css"/>
    </head>
		...
		<div  class=" c-size-md c-bg-grey-1"style="margin:-33px 0px -21px 0px;">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-5 c-margin-b-20">
						<form name="login-form" class="">
					    	<div class="c-content-media-1 " style="margin-top: 40px; margin-bottom: 100px;" >
								<div class="c-content-title-3 c-title-md c-center" style="border:none; padding-left: 0px;">
									...
									<h3 class="c-font-green-4 c-font-uppercase c-font-bold">Payment Successful</h3>
								</div>
								<hr>
								...
								<div class="row" style="margin-left:-5px;">
									<div class="form-group col-md-9 pull-left mt-10">
										<button type="text" class="btn btn-primary btn-xs">
											<a style="color: white;" href="#"><small>Download Receipt</small></a>
										</button>
									</div>
									<div class="form-group  col-md-3 pull-right mt-10" style="">
										<button type="submit" class="btn btn-primary btn-xs">
											<a style="color: white;" href="#"><small>Close</small></a>
										</button>
									</div>
								</div>	
							</div>
