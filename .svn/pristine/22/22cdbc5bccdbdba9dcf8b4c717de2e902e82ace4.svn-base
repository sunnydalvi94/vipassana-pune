                                                ...
                                                <div class="row" data-auto-height="true">
                                                    <div class="col-md-4"></div>
                                                        <div class="col-md-4 c-margin-b-20">
                                                            <form id="reset-password"  action="reset-password" data-apikey="5681648d-91d6-4371-a911-1497734d0016" method="post" enctype="multipart/form-data" class="comment-form validate"data-redirect="site">
                                                                <div class="c-content-media-1">
                                                                    ...
                                                                    <div class="c-content-title-3 c-title-md " style="border:none; padding-left: 0px;">
                                                                        <h3 class="c-theme-font c-font-uppercase c-font-bold">Reset Password </h3>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="input-icon right" style="float: initial !important;">
                                                                            <i class="fa"></i>
                                                                             <input placeholder="New Password" class="form-control c-theme  placeholder-no-fix " name="new_password" type="password"required>
                                                                           </div>  
                                                                        </div>
                                                                         <div class="form-group col-md-12 ">
                                                                    ...
                                                                    <div class="row">
                                                                       <!--  <input type="hidden" name="role_id" value="1">
                                                                        ...
                                                                        <input type="hidden" name="activation_code" >
