                ...
                <div class="row">
                    <div class="col-md-12">
                        <?php if(isset($album_image_data) && !empty($album_image_data)) {
                            $i=1;
                            foreach($album_image_data as $key) 
                            { ?>
                ...
                <?php if(isset($album_image_data) && !empty($album_image_data)) {
                    ...
                    <div class="c-content-isotope-item animate fadeInUp" data-wow-delay="0">
                        <div class="c-content-isotope-image-container">
                            <img class="c-content-isotope-image" src="<?php echo base_url();?>assets/site/img/center/<?php echo(isset($key->album_image_path) && !empty($key->album_image_path))?$key->album_image_path:'';?>"/>
                            <div class="c-content-isotope-overlay c-ilightbox-image-2"
                                href="<?php echo base_url();?>assets/site/img/center/<?php echo(isset($key->album_image_path) && !empty($key->album_image_path))?$key->album_image_path:'';?>"
                                data-options="thumbnail:'<?php echo base_url();?>assets/site/img/center/<?php echo(isset($key->album_image_path) && !empty($key->album_image_path))?$key->album_image_path:'';?>'"
