...
<head>
	<meta charset="utf-8"/>
	<title>Add About Vipassana | Vipassana </title>
					...
					<div class="portlet light" style="padding: 15px 30px 15px 30px;">
						<div class="portlet-title">
							<div class="caption font-blue">
                                ...
                                <span class="caption-subject bold uppercase">Add About Vipassana</span>
                            </div>
						</div>
						<div class="portlet-body form">
							<form action="about" id="about" data-apikey="<?php echo (isset($keydata->key) && !empty($keydata->key))?$keydata->key:''; ?>" data-redirect="about-vipassana" class="horizontal-form" method="post" enctype="multipart/form-data">
							  	<div class="form-body">
								    <div class="row"> 
								    	<div class="col-md-12">
								    		<div class="row">
									    		<div class="form-group col-md-6">
									    			...
									    			<div class="input-icon right"><i class="fa"></i>
									    				...
									    				name="about_name" value="<?php echo(isset($about_data->about_name) && !empty($about_data->about_name))?$about_data->about_name:'';?>"placeholder="Name">
									    			</div>
									    		</div>
									    		<div class="form-group col-md-6">
								                    <p class="control-label">Enter Url<span class="require" style="color:red"><small>*</small> </span></p>
								                    <div class="input-icon right"> <i class="fa"></i>
								                        <input type="text" class="form-control" name="video" value="<?php echo(isset($about_data->video) && !empty($about_data->video))?$about_data->video:'';?>" placeholder="Enter URL"/>
								                    </div>
											    </div>
								    		</div>
								    		...
								    		<div class="form-group">
								    			...
								    			<div class="input-icon right"><i class="fa"></i>
								    				...
								    				placeholder="Description"style="color: #5c6873;"><?php echo(isset($about_data->about_description) && !empty($about_data->about_description))?$about_data->about_description:'';?></textarea>
								    			</div>
								    		</div>
						    	...
						    	<input type="hidden" name="about_id" value="<?php echo(isset($about_data->about_id) && !empty($about_data->about_id))?$about_data->about_id:'';?>">
							  	<div class="form-actions ">
							  		<div container>
							  			<div class="row">
							  				<div class="col-md-2 col-sm-12"style='margin-bottom: 10px;'>
							  					  <a href="<?php echo base_url();?>about-vipassana"class="btn btn-primary"type="button"><i class=" icon-arrow-left "></i> Back</a>
							  				</div>
							  				<div class="col-md-7">
							  				</div>
							  				<div class="col-md-2  col-sm-12" style="width: 12.6%;margin-bottom: 10px;">
							  					<button type="reset" class="btn btn-danger"> <i class="icon-close"></i> Clear </button>
							  				</div>
							  				<div class="col-md-2  col-sm-12"style="width: 12%;">
							  					<button type="submit" class="btn btn-primary common_save" data-pk="about_id" rel="<?php echo(isset($about_data->about_id) && !empty($about_data->about_id))?$about_data->about_id:'';?>"> <i class="icon-check"></i> <?php echo(isset($about_data->about_id) && !empty($about_data->about_id))?'Update':'Submit';?> </button> 
							  				</div>
							  			</div>
							  		</div>
							    </div>	
