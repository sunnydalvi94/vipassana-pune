...
<head>
	<meta charset="utf-8"/>
	<title>Add Frequently Asked Questions | Vipassana </title>
					...
					<div class="portlet light"style="padding: 15px 30px 15px 30px;">
						<div class="portlet-title">
							<div class="caption font-blue">
                                ...
                                <span class="caption-subject bold uppercase">Add Frequently Asked Questions</span>
                            </div>
						</div>
						<div class="portlet-body form">
							<form action="faq" id="faq" data-apikey="<?php echo (isset($keydata->key) && !empty($keydata->key))?$keydata->key:''; ?>" data-redirect="frequently-asked-questions" class="horizontal-form" method="post" enctype="multipart/form-data">
							  	<div class="form-body">
								    <div class="row"> 
								    	<div class="col-md-10">
								    		<div class="form-group">
								    			<p class="control-label">Question<span class="require" aria-required="true" style="color:red"><small>*</small></span></p>
								    			<div class="input-icon right"><i class="fa"></i>
								    				...
								    				placeholder="Write Question Here"required maxlength="254" minlength="7" >
								    			</div>
								    		</div>
								        </div>		
								        <div class="col-md-2">
								    		<div class="form-group">
								    			<p class="control-label">Sequence<span class="require" aria-required="true" style="color:red"><small>*</small></span></p>
								    			<div class="input-icon right"><i class="fa"></i>
								    				<input type="text" class="form-control" 
								    				name="sequence" value="<?php echo(isset($faq_data->sequence) && !empty($faq_data->sequence))?$faq_data->sequence:'';?>"
								    				placeholder="Sequence"required maxlength="6" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
								    			</div>
								    		</div>
								    	</div>	
								    	<div class="col-md-12">	
								    		<div class="form-group">
								    			...
								    			<div class="input-icon right"><i class="fa"></i>
								    				...
								    				name="answer" rows="8" 
								    				placeholder="Write Ideal Answer for Above Question" maxlength="900" required><?php echo(isset($faq_data->answer) && !empty($faq_data->answer))?$faq_data->answer:'';?></textarea>
								    			</div> 
								    		</div>
								    	</div>
								    </div> 
						    	...
						    	<input type="hidden" name="faq_id" value="<?php echo(isset($faq_data->faq_id) && !empty($faq_data->faq_id))?$faq_data->faq_id:'';?>">
								  ...
								  <a href="<?php echo base_url();?>frequently-asked-questions"class="btn btn-primary"type="button" 
								  	><i class=" icon-arrow-left "></i> Back</a>
								  	<div class="pull-right">	
									  	<button type="reset" class="btn btn-danger"> <i class="icon-close"></i> Clear </button>
										<button type="submit" class="btn btn-primary common_save" data-pk="faq_id" rel="<?php echo(isset($faq_data->faq_id) && !empty($faq_data->faq_id))?$faq_data->faq_id:'';?>"> <i class="icon-check"></i> <?php echo(isset($faq_data->faq_id) && !empty($faq_data->faq_id))?'Update':'Submit';?> </button> 
