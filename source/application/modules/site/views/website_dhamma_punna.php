...
<header class="c-layout-header c-layout-header-3 c-layout-header-3-custom-menu c-layout-header-dark-mobile" data-minimize-offset="80">
                    ...
                    <nav class="c-mega-menu c-pull-right c-mega-menu-dark c-mega-menu-dark-mobile c-theme c-fonts-uppercase c-fonts-bold" >
                       <ul class="nav navbar-nav c-theme-nav"> 
                            ...
                            <li class=" c-menu-type-classic">
                                <a href="#about" class="c-link dropdown-toggle">ABOUT CENTER<span class="c-arrow c-toggler"></span></a>
                            </li>
                            <li class=" c-menu-type-classic">
                                <a href="#reach" class="c-link dropdown-toggle">How to Reach<span class="c-arrow c-toggler"></span></a>
                            </li>
                            <li class=" c-menu-type-classic">
    ...
    <section>
       <div id="feature-14-1" class="c-content-feature-14 c-bg-white" style="padding:40px 0px;overflow:hidden">
            <div class="container">
                ...
                <section>
                    <div class="c-content-box c-size-md 1" style="padding:70px 0px;">
                        <div class="container text-justify">
                            ...
                            The centre spreads over 3 acres of land and can accommodate 50 males and 40 females students.
                            Every month there is 10 day course, 3 day course, 1 day course for old students children 1 day, children residential courses are conducted at Dhamma Punna Vipassana Meditation Centre.</p>
                            <p>Dhamma Punna, meaning the Land to Accrue Merits, was established in the year 2000.
                            The centre spreads over 3 acres of land and can accommodate 50 males and 40 females students.
                            Every month there is 10 day course, 3 day course, 1 day course for old students children 1 day, children residential courses are conducted at Dhamma Punna Vipassana Meditation Centre.</p>
                            <p>Dhamma Punna, meaning the Land to Accrue Merits, was established in the year 2000.
    ...
    <section>
        <div class="markal_route c-content-box c-size-md c-bg-grey-1" style="padding:30px 60px 20px 60px;">
            <div class="container">
                <div class="c-content-title-1 " >
                    <h3 class="c-center c-font-uppercase c-font-bold"style="margin-bottom:10px;font-size:22px;">How to Reach to Center</h3>
                    <div class="c-line-center c-theme-bg " style="margin-bottom:15px;"></div>
                </div>
                    ...
                    <div class=" c-margin-b-20" >
                        <div class="c-content-media-1 " data-height="height"style="padding:30px 0px 30px 50px;">
                            <div class="c-content-title-3 c-title-md " style="border:none; padding-left: 0px;">
                                <h3 class="c-theme-on-hover c-font-uppercase c-font-bold">Cab from Corporation to Markal</h3>
                            </div>
                            <div class="row">
                                <div class="col-md-5">
                                    <table style="line-height: 40px;" >
                                        <tr>
                                            ...
                                            <td>
                                                <span> &nbsp;via New Airport Rd and Wadgaon</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <span> &nbsp;Rd 57 min (28.7 km)</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <span class="c-content-title-3 c-title-md  c-theme-on-hover c-font-bold" style="border:none;padding-left: 0px;"><i style="" class="fa fa-inr  c-theme-font">&nbsp;&nbsp;&nbsp;</i>Cab Cost&nbsp;:</span>
                                            </td>
                                            <td>
                                                <span> &nbsp;400Rs</span>
                                            </td>
                                ...
                                <div class="col-md-5">
                                    <table style="line-height: 40px;" >
                                        <tr>
                                            ...
                                            <td>
                                                <span> &nbsp;via Alandi Rd/St Dnyaneshwar</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <span> &nbsp;Shinde Road 1hr 3min (26.0 km)</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                ...
                <div class="row" data-auto-height="true">
                    <div class=" c-margin-b-20" >
                        <div class="c-content-media-1 " data-height="height" style="padding:30px 0px 30px 50px;">
                            <div class="c-content-title-3 c-title-md " style="border:none; padding-left: 0px;">
                                <h3 class="c-theme-on-hover c-font-uppercase c-font-bold">Cab from Corporation to Mumbai</h3>
                            </div>
                            <div class="row">
                                <div class="col-md-5">
                                    <table style="line-height: 40px;" >
                                        <tr>
                                            ...
                                            <td>
                                                <span> &nbsp;via Bengaluru - Mumbai</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                ...
                <div class="row" data-auto-height="true">
                    <div class=" c-margin-b-20" >
                        <div class="c-content-media-1 " data-height="height" style="padding:30px 0px 30px 50px;">
                            <div class="c-content-title-3 c-title-md " style="border:none; padding-left: 0px;">
                                <h3 class="c-theme-on-hover c-font-uppercase c-font-bold">Bus Timing from Corporation to Wagholi and Vice Versa:</h3>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <table style="line-height: 40px;" >
                                        <tr>
                                            ...
                                            <td>
                                                <span> &nbsp;The public bus (PMT- Pune Municipal Transport) is available for every 15 Min</span>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                ...
                <div class="row" data-auto-height="true">
                    <div class=" c-margin-b-20" >
                        <div class="c-content-media-1 " data-height="height" style="padding:30px 30px 30px 50px;">
                            <div class="c-content-title-3 c-title-md " style="border:none; padding-left: 0px;">
                                <h3 class="c-theme-on-hover c-font-uppercase c-font-bold">Bus Timing From Wagholi to Markal</h3>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <table class="table" style="line-height: 40px;" >
                                        <tr>
                                            ...
                                            <td class="c-text  c-font-16  c-font-regular">7.25 a.m.</td>
                                            <td class="c-text  c-font-16  c-font-regular">9.00 a.m.</td>
                                            <td class="c-text  c-font-16  c-font-regular">
                                                11.05 a.m.
                                                <b>Preferred</b>
                                            </td>
                                            <td class="c-text  c-font-16  c-font-regular" >15.45 p m.</td>
                                            <td class="c-text  c-font-16  c-font-regular">17.15 p.m.</td>
                                            <td class="c-text  c-font-16  c-font-regular">18.50 p.m.</td>
                                            <td class="c-text  c-font-16  c-font-regular">21.00 p.m</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                ...
                <div class="row" data-auto-height="true">
                    <div class=" c-margin-b-20" >
                        <div class="c-content-media-1 " data-height="height" style="padding:30px 30px 30px 50px;">
                            <div class="c-content-title-3 c-title-md " style="border:none; padding-left: 0px;">
                                <h3 class="c-theme-on-hover c-font-uppercase c-font-bold">Bus Timing From Markal to Wagholi</h3>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <table class="table" style="line-height: 40px;" >
                                        <tr>
                                            ...
                                            <td class="c-text  c-font-16  c-font-regular">6.40 a.m.</td>
                                            <td class="c-text  c-font-16  c-font-regular">8.10 a.m.</td>
                                            <td class="c-text  c-font-16  c-font-regular">
                                                10.20 a.m.
                                                <b>Preferred</b>
                                            </td>
                                            <td class="c-text  c-font-16  c-font-regular">11.50 a.m.</td>
                                            <td class="c-text  c-font-16  c-font-regular">16.30 p.m.</td>
                                            <td class="c-text  c-font-16  c-font-regular">18.00 p.m.</td>
                                            <td class="c-text  c-font-16  c-font-regular">20.10 p.m.</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
        ...
        <div class="route_information">
            <div class="container">
                <div class="col-md-12 " style="padding-top:50px;">
                    <div class="row">    
                        <div class="c-content-title-1 " >
                                <h3 class="c-center c-font-uppercase c-font-bold"style="margin-bottom:10px;font-size:22px;">Contact Us</h3>
                                <div class="c-line-center c-theme-bg " style="margin-bottom:15px;"></div>
                        </div>
                    </div>
                </div>
    ...
    <section>
        <div class="container" style="margin-top:30px; overflow-x: hidden;">
            <div class="row">
                <div class="col-md-5 " >
                    <div class="c-content-title-1 "  >
                        <h3 class=" c-font-uppercase c-font-bold"style="margin-bottom: 10px;font-size: 22px;margin-left: 34px;">CITY OFFICE</h3>
                        <div class="c-line-center c-theme-bg"style="margin: 0 auto 15px 73px;"></div>
                    </div>
                    <div class="c-address " style="margin-bottom:10px;">
                        <table style="line-height:25px;" class="text-justify">
                            <tr>
                ...
                <div class="col-md-6">
                    <div class="map container">
                        <div class="mapouter"><div class="gmap_canvas"><iframe width="1000px;" height="500px;" id="gmap_canvas" src="https://maps.google.com/maps?q=Dhammananda%20Village%20Markal%2C%20District%20Pune%2C%20Pune%20-%20412105%20Maharashtra%2C%20India&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.mahjong-play.com"></a></div><style>.mapouter{position:relative;text-align:right;height:500px;width:600px;}.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:600px;}</style></div>
                    </div>
                </div>
            </div>
        </div>
