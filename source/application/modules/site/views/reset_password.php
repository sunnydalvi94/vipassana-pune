...
<html lang="en"  >
    ...
    <head>
    <meta charset="utf-8"/>
        <title>Reset  Password | Vipassana</title>
    ...
    <body class="c-layout-header-fixed c-layout-header-mobile-fixed">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row" data-auto-height="true">
                                                    ...
                                                    <div class="col-md-4 c-margin-b-20"style="height: 300px;">
                                                       <form id="verify-activation-link"  action="verify-activation-link" data-apikey="5681648d-91d6-4371-a911-1497734d0016" method="post" enctype="multipart/form-data" class="comment-form validate" data-redirect="reset-password-page" >
                                                            <div class="row">
                                                                <!-- <input type="hidden" name="role_id" value="1">
                                                                <input type="hidden" name="user_id" value="1"> -->
                                                                <input type="hidden" name="activation_code" id="act_value" value="">
                                                                <div class="form-group form-actions  col-md-3 mt-10" style="">
                                                                    <button  id="btn_click" type="submit" style="display: none;"  data-pk="user_id" class="btn btn-primary btn-xs pull-right common_save">
                                                                         check <i class="m-icon-swapright m-icon-white"></i>
                                                                    </button>
                                                                    <a id="unmatch_act_code" href="<?php echo base_url(); ?>forgot-password"></a>  
                                                                </div>
                                                            </div>  
                                                        </form>
                                                    </div>
        ...
        <script type="text/javascript">
            document.addEventListener('DOMContentLoaded', function(){
                ...
                setTimeout (function(){
                    document.getElementById('unmatch_act_code').click()
                },3000)
                var path=(window.location.pathname);
                var str =path;
                var res = str.split("/");
                var value1=(res[2]);
                var act_value=document.getElementById('act_value').value = value1;
            }); 
        </script>
    </body>
</html>
