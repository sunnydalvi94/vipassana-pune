...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Dhamma Ananda Gallery | Vipassana</title>
            ...
            <div class=" c-size-md c-bg-img-center" style=" margin-bottom:45px;">
                <div class="container">
                    <div class="c-body">
                        <div class="row">
                            <div class="col-md-12">
                                <?php if(isset($ananda_gallery_data) && !empty($ananda_gallery_data)) {
                                    $i=1;
                                    foreach($ananda_gallery_data as $key) 
                                    { ?>
                            ...
                            <div class="c-content-isotope-item animate fadeInUp" data-wow-delay="0">
                                <div class="c-content-isotope-image-container">
                                    ...
                                    <div class="c-content-isotope-overlay c-ilightbox-image-2"
                                        ...
                                        data-caption="<h4>Markal Center</h4><p><?php echo (isset($key->album_image_description) && !empty($key->album_image_description))?$key->album_image_description:''; ?></p>">
