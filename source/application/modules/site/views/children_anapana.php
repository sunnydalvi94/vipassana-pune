...
<html lang="en">
	...
	<head>
	    <meta charset="utf-8" />
	    <title>Children Anapana | Vipassana </title>
			    ...
			    <div class=" c-size-md">
				    <div class="container-fluid"style="padding: 0px 30px 0px 30px;">
					        ...
					        <div class="row">
					            <div class="col-md-12">
						            <div class="c-content-title-2">
						              <h3 class="c-center" style=";margin-bottom: 15px;">Children Anapana</h3>
				        ...
				        <script type="text/javascript">
				        	function onTabAll(par){
				            window.location=window.location.pathname + '#' +par;}
				        </script>
				        <div class="col-md-12 col-sm-12">
					        <div class="table2">
					            <div class="c-content-tab-4 c-opt-3 tab_content" role="tabpanel" class=" ">
						            <ul class="nav nav-justified" role="tablist">
						                ...
						                <a href="#tab-5"  role="tab"  onclick="onTabAll('all')" data-toggle="tab">All</a>
						                </li>
						                <?php if(isset($one_day_course_data) && !empty($one_day_course_data)) {
						                  foreach($one_day_course_data as $key) { ?>
							              <li role="presentation" class=""  id="tab_id">
							                <a href="#tab-<?php echo (isset($key->one_day_course_id) && !empty($key->one_day_course_id))?$key->one_day_course_id:''; ?>"  onclick="onTabChange(<?php echo (isset($key->one_day_course_id) && !empty($key->one_day_course_id))?$key->one_day_course_id:''; ?>)" role="tab" data-toggle="tab"><?php echo (isset($key->one_day_course_area) && !empty($key->one_day_course_area))?$key->one_day_course_area:''; ?></a>
							              </li>
						                	<?php 
						                	}
						                } ?>
						            ...
						            <div class="tab-content">
						                <?php if(isset($one_day_course_data) && !empty($one_day_course_data)) { 
						                foreach($one_day_course_data as $key) { ?>
							                <div role="tabpanel" class="tab-pane fade in active" id="tab-<?php echo (isset($key->one_day_course_id) && !empty($key->one_day_course_id))?$key->one_day_course_id:''; ?>">
								                                ...
								                                <table  class="table table-bordered  " style="width:100%;">
									                                <thead>
										                                <tr>
										                                  ...
										                                  <th><h3><span class="glyphicon glyphicon-picture  c-theme-font"></span>&nbsp; <span class="c-theme-on-hover"> Image</span></h3></th>
										                                  <th><h3><i style="" class="fa fa-map-marker c-theme-font">&nbsp;</i>Google Map</h3></th>
										                                </tr>
									                                </thead>
									                                <tbody >
										                                <tr >
										                                  <th scope="row" >
										                                  <?php echo (isset($key->one_day_course_area) && !empty($key->one_day_course_area))?$key->one_day_course_area:''; ?>
										                                  </th>
										                                  <td>
										                                  <?php echo (isset($key->day) && !empty($key->day))?$key->day:''; ?>
										                                  </td>
										                                  <td>
										                                  <?php echo (isset($key->time) && !empty($key->time))?$key->time:''; ?>
										                                  </td>
										                                  <td style="text-align:left;">
										                                  <?php echo (isset($key->one_day_course_address) && !empty($key->one_day_course_address))?$key->one_day_course_address:''; ?>
										                                  </td>
										                                  <td>
										                                  <?php echo (isset($key->contact_no) && !empty($key->contact_no))?$key->contact_no:''; ?>
										                                  </td>
										                                  <td>
										                                    <div class="zoom-in">
										                                      <div  class="text c-theme-on-hover"><b style="text-align: center;">View</b></div>
										                                        <div class="overlay">
										                                        <img style="height: 134px;width: 240px;" src="<?php echo base_url(); ?>uploads/one_day_course_images/<?php echo (isset($key->one_day_course_image) && !empty($key->one_day_course_image))?$key->one_day_course_image:'';?>"  alt="Avatar" class="image">
										                                      </div>
										                                    </div>
										                                  <td>
										                                  <a class="vertical-align" target="_blank" href=" <?php echo (isset($key->google_map) && !empty($key->google_map))?$key->google_map:''; ?>"><span>&nbsp; <img style="height:50px;" src="<?php echo base_url(); ?>assets/site/img/logo/google_map1.jpg"> </span></a>  
										                                  </td>
										                                </tr>
									                                </tbody>
								                                </table>
											                                ...
											                                <tbody >
											                                    ...
											                                    foreach($one_day_course_data as $key) { ?>
											                                        <tr >
											                                            ...
											                                            <td>
											                                                <div class="zoom-in">
												                                                <div  class="text c-theme-on-hover"><b style="text-align: center;">View</b>
												                                                </div>
												                                                <div class="overlay">
												                                                  <img style="height: 134px;width: 240px;" src="<?php echo base_url(); ?>uploads/one_day_course_images/<?php echo (isset($key->one_day_course_image) && !empty($key->one_day_course_image))?$key->one_day_course_image:'';?>"  alt="Avatar" class="image">
												                                                </div>
					        ...
					        <div class="table1">
					            <?php if(isset($one_day_course_data) && !empty($one_day_course_data)) {
					            foreach($one_day_course_data as $key) { ?>
						            <div style="border:20px solid  #f6f9fb;padding:15px;">
						                <div  class="row">
							                <div class="col-md-2">
							                  <!-- <h3 class="c-font-bold"><i class="fa fa-map-marker c-theme-font ">&nbsp;</i> Area</h3> -->
							                  <h2 class="c-theme-font c-center c-font-uppercase c-font-bold">
							                  <?php echo (isset($key->one_day_course_area) && !empty($key->one_day_course_area))?$key->one_day_course_area:''; ?> 
							                  </h2>
							                </div>
							                <div class="col-md-2">
							                  <h3 class="c-font-bold"><i class="fa fa-calendar  c-theme-font">&nbsp;</i>Day</h3></th>
							                  <p>
							                    <?php echo (isset($key->day) && !empty($key->day))?$key->day:''; ?>
							                  </p>
							                </div>
							                <div class="col-md-2">
							                  <h3 class="c-font-bold"><i class="fa fa-clock-o  c-theme-font">&nbsp;</i>Time</h3>
							                  <p>
							                 <?php echo (isset($key->time) && !empty($key->time))?$key->time:''; ?>  
							                  </p>
							                </div>
							                <div class="col-md-2">
							                  <h3 class="c-font-bold"><i style="" class="fa fa-map-marker  c-theme-font">&nbsp;</i>Address</h3>
							                  <p>
							                   <?php echo (isset($key->one_day_course_address) && !empty($key->one_day_course_address))?$key->one_day_course_address:''; ?>
							                  </p>
							                </div>
							                <div class="col-md-2">
							                  <h3 class="c-font-bold"><i class="glyphicon glyphicon-phone-alt  c-theme-font"></i>&nbsp;Contact</h3>
							                  <p>
							                 <?php echo (isset($key->contact_no) && !empty($key->contact_no))?$key->contact_no:''; ?>
							                  </p>
							                </div>
							                <div class="col-md-1">
							                  <h3 class="c-font-bold"><span class="glyphicon glyphicon-picture  c-theme-font"></span>&nbsp; <span class="c-theme-on-hover"> Image</span></h3>
							                  <div class="zoom-in" style="z-index: 1">
							                      <p class="text c-theme-on-hover"><b>View</b></p>
							                      <div class="overlay">
							                      <img style="height: 134px;width: 240px;" src="<?php echo base_url(); ?>uploads/one_day_course_images/<?php echo (isset($key->one_day_course_image) && !empty($key->one_day_course_image))?$key->one_day_course_image:'';?>"  alt="Avatar" class="image">
							                      </div>
							                  </div>
							                ...
							                <div class="col-md-1">
							                  <h3 class="c-font-bold"><i style="" class="fa fa-map-marker c-theme-font">&nbsp;</i>Google Map</h3>
							                  <p> 
							                     <a class="vertical-align" target="_blank" href=" <?php echo (isset($key->google_map) && !empty($key->google_map))?$key->google_map:''; ?>"><span>&nbsp; <img style="height:50px;" src="<?php echo base_url(); ?>assets/site/img/logo/google_map1.jpg"> </span></a>
							                  </p>
							                </div>
