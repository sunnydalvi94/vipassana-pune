				...
				<div class="container" >
						...
						<div class="row">
							<div class="col-md-12">
								<div class="c-content-title-2"style="padding-top:30px;">
									<h3 class="c-center">Donation - For Old Vipassana Students </h3>
										...
										<div class="col-md-12">
											<div class="row" data-auto-height="true">
										    	<div class="col-md-8  c-margin-b-20">
													<div class="c-content-media-1 " data-height="height">
														<div class="c-content-title-3 c-title-md " style="border:none; padding-left: 0px;">
															<h3 class="c-font-blue-1 c-font-uppercase c-font-bold">Donate Without Login</h3>
														</div>
														<hr>
														<form  id="donation-form" action="donation-form" class="comment-form validate" data-apikey="5681648d-91d6-4371-a911-1497734d0016" method="post">
															<div class="row">
																<div class="form-group col-md-6 ">
																	...
																	<div class="input-icon right" style="float: initial !important;">
	                                                                    <i class="fa "></i>
																		<input placeholder="First Name" class="form-control c-theme" value="<?php echo(isset($donation_data->first_name) && !empty($donation_data->first_name))?$donation_data->first_name:'';?>" name="first_name"  type="text" required oninput="this.value = this.value.replace(/[^a-zA-Z.]/g, '').replace(/(\..*)\./g, '$1');">
																	</div>	
																</div>
																<div class="form-group col-md-6 ">
																	...
																	<div class="input-icon right" style="float: initial !important;">
	                                                                    <i class="fa"></i>
																		<input   placeholder="Last Name" class="form-control c-theme " value="<?php echo(isset($donation_data->last_name) && !empty($donation_data->last_name))?$donation_data->last_name:'';?>" name="last_name" type="text" required oninput="this.value = this.value.replace(/[^a-zA-Z.]/g, '').replace(/(\..*)\./g, '$1');">
																	</div>	
																</div>
															</div>
															<div class="row">
																<div class="form-group col-md-6 " >
																	...
																	<div class="input-icon right" style="float: initial !important;">
	                                                                    <i class="fa"></i>
																		<input placeholder="Phone Number" class="form-control c-theme " value="<?php echo(isset($donation_data->contact_number) && !empty($donation_data->contact_number))?$donation_data->contact_number:'';?>" name="contact_number" type="text"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  maxlength="10" required>
																    </div>		
																</div>
																<div class="form-group col-md-6 "  >
																	...
																	<div class="input-icon right" style="float: initial !important;">
	                                                                    <i class="fa"></i>
																		<input   placeholder="Email" class="form-control c-theme " value="<?php echo(isset($donation_data->email) && !empty($donation_data->email))?$donation_data->email:'';?>"name="email"  type="email" required>
																    </div>
																</div>
															</div>
															<div class="row">
																<div class="form-group col-md-6 " >
																	...
																	<div class="input-icon right" style="float: initial !important;">
	                                                                    <i class="fa"></i>
																		<input placeholder="Address line1" class="form-control c-theme " value="<?php echo(isset($donation_data->address_line_1) && !empty($donation_data->address_line_1))?$donation_data->address_line_1:'';?>" name="address_line_1"  type="text" maxlength="50" required>
																	</div>	
																</div>
																<div class="form-group col-md-6">
																	<label class="f-size">Address Line2</label>
																	<input   placeholder="Address line2" class="form-control c-theme" value="<?php echo(isset($donation_data->address_line_2) && !empty($donation_data->address_line_2))?$donation_data->address_line_2:'';?>" name="address_line_2"type="text" maxlength="50">
																</div>
															</div>
															<div class="row">
																<div class="form-group col-md-6 "  >
																	...
																	<div class="input-icon right" style="float: initial !important;">
	                                                                    <i class="fa"></i>
																		<input   placeholder="Zip/Pin Code" class="form-control c-theme " value="<?php echo(isset($donation_data->pin_code) && !empty($donation_data->pin_code))?$donation_data->pin_code:'';?>" name="pin_code"  type="text" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="6">
																	</div>	
																</div>
																<div class="form-group col-md-6 ">
															...
															<div class="row">
																<div class="form-group col-md-4 ">
																	...
																	<div class="input-icon right" style="float: initial !important;">
	                                                                    <i class="fa"></i>
																		<input placeholder="City" class="form-control c-theme " value="<?php echo(isset($donation_data->city) && !empty($donation_data->city))?$donation_data->city:'';?>" name="city"  type="text" required oninput="this.value = this.value.replace(/[^a-zA-Z-,.]/g, '').replace(/(\..*)\./g, '$1');">
																	</div>	
																</div>
																<div class="form-group col-md-4 " >
																	...
																	<div class="input-icon right" style="float: initial !important;">
	                                                                    <i class="fa"></i>
																		<input   placeholder="State" class="form-control c-theme " value="<?php echo(isset($donation_data->state) && !empty($donation_data->state))?$donation_data->state:'';?>" name="state" type="text" required oninput="this.value = this.value.replace(/[^a-zA-Z.]/g, '').replace(/(\..*)\./g, '$1');">
																    </div>
																</div>
																<div class="form-group col-md-4 " >
																	...
																	<div class="input-icon right" style="float: initial !important;">
	                                                                    <i class="fa"></i>
																		<input placeholder="Country" class="form-control c-theme " value="<?php echo(isset($donation_data->country) && !empty($donation_data->country))?$donation_data->country:'';?>" name="country"  type="text" required oninput="this.value = this.value.replace(/[^a-zA-Z.]/g, '').replace(/(\..*)\./g, '$1');">
																	</div>	
																</div>
															</div>
															<div class="row">
																<div class="form-group col-md-12">
																	<label class="f-size">Remark</label>
																	<input   placeholder="" class="form-control c-theme " value="<?php echo(isset($donation_data->remark) && !empty($donation_data->remark))?$donation_data->remark:'';?>" name="remark" type="text" maxlength='100' >
																</div>
															</div>
															<div class="row">
																<div class="form-group col-md-6 " >
																	<label class="f-size">Amount in INR(Rs) Only<span style="color: red;">*</span></label>
																	<div class="input-icon right" style="float: initial !important;">
	                                                                    <i class="fa"></i>
																		<input class="form-control c-theme " value="<?php echo(isset($donation_data->amount) && !empty($donation_data->amount))?$donation_data->amount:'';?>" name="amount" maxlength="9" type="text" required  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
																	</div>	
																</div>
															</div>
															<input class="form-control c-theme " value="<?php echo(isset($donation_data->status) && !empty($donation_data->status))?$donation_data->status:'';?>" name="status"  type="hidden">
															<input class="form-control c-theme " value="<?php echo(isset($donation_data->date_time) && !empty($donation_data->date_time))?$donation_data->date_time:'';?>" name="date_time"  type="hidden">
															<tr>
																<td>
																	<span class="c-checkbox has-info" >
									                                    <input id="check_donation" type="checkbox"class="c-check">
									                                    <label for="check_donation">
									                                    <span></span>
																...
																<td > <span style="text-justify"> I agree to have attended at least one 10 day Vipassana course in the tradition of Sayagyi U Bha Khin as taught by S.N. Goenka.</span></td>
															</tr>
															<br>
															<div class="row">
																<div class="form-group  col-md-3 pull-right mt-10"  style="">
																   <button class="btn btn-primary btn-xs form-control common_save btncheck" rel="<?php echo(isset($donation_data->donation_id) && !empty($donation_data->donation_id))?$donation_data->donation_id:'';?>" data-pk="donation_id" >Submit</button>
																</div>
															</div>	
														</form>
													</div>
												...
												<div class="col-md-4 c-margin-b-20">
												    <form  action="donation_login" id="login1" method="post">
												    	<div class="c-content-media-1">
															<div class="c-content-title-3 c-title-md " style="border:none; padding-left: 0px;">
																<h3 class="c-font-blue-1 c-font-uppercase c-font-bold">Login</h3>
															</div>
															...
															<div class="row">
																...
																<input placeholder="Username" class="form-control c-theme  placeholder-no-fix " name="username" type="text">
																</div>
															</div>
															<div class="row">
																<div class="form-group col-md-12">
																<label class="control-label visible-ie8 visible-ie9">Password</label>
																<input   placeholder="Password" class="form-control c-theme  placeholder-no-fix" name="password" type="password">
																</div>
															</div>
															<div class="row">
															...
															<div class="row">
																...
																<div class="form-group form-actions  col-md-3 pull-right mt-10" style="">
																	<button type="submit" class="btn btn-primary btn-xs pull-right donation_login">
					    ...
					    <div class="col-md-12">
	                        <div style="">
	                            <div class="c-content-title-3 c-title-md c-border-blue-2">
	                                <h3 class=" ">Making a Donation (using Debit/Credit Card, Internet Banking) &nbsp; &nbsp; &nbsp;<span><img alt='Debit/Credit card logo' height="40px" width="200px" title='Visa/Master Debit/Credit Card' src='assets/site/img/bank/Visa_master_logo1.jpg'/> </span> </h3>
	                            </div>
	                        </div>
	                    </div> 
	                </div>
					<div class=" container"  style="padding:20px;">
					    <div class="col-md-12 text-justify" >
							<div class="c-content-title-3 c-title-md c-border-blue-2">
								<h3 class="c-font-blue-2">Parami Of Generosity</h3>
							</div>
							<div style="margin-left:22px;">
								<p>-According to the tradition of pure Vipassana, courses are run solely on a donation basis from old students.</p>
								<p>-In this way courses are supported by those who have realized for themselves the benefits of the practice. Wishing to share these benefits with others, one gives a donation according to one's means and volition.</p>
								<p>-Such donations are the only source of funding for course in this tradition around the world. There is no wealthy foundation or individual sponsoring them.</p>
								<p>-Neither the teachers nor the organizers receive any kind of payment for their service.</p>
								<p>-Thus, the spread of Vipassana is carried out with purity of purpose, free from any commercialism.</p>
								<p>-Donations are accepted only from old students i.e. from students who have completed at least one ten-day Vipassana course with S.N. Goenka or one of his assisting teachers.</p>
							</div>
		                </div> 
	                </div>
					<div  style="padding:20px;">
					    <div class="container" >
	                        <div>
								<div class="c-content-title-3 c-title-md c-border-blue-2">
									<h3 class="c-font-blue-2">Donation Made to Pune VIPASSANA SAMITI Have 50% Exception Under Section 80G of the Income Tax Act.</h3>
								</div>
								<div style="margin-left:22px; line-height:35px;">
									<table style="line-height: 40px;" >
										<tr>
											...
											<td>
												<span > &nbsp; <a style="color:#5c6873;" class="c-theme-on-hover" href="<?php echo base_url(); ?>assets/site/img/certificate/12aCertificate.jpg" download> <u>Download 12A Certificate</u></a></span>
											</td>
										</tr>
											<tr>
											<td>
											...
											<td>
												<span > &nbsp; <a style="color: #5c6873;" class="c-theme-on-hover" href="<?php echo base_url(); ?>assets/site/pdf/income_tax_letter.pdf" download> <u>Download the IT Exemption Certificate and related information</u></a></span>
											</td>
										</tr>
									</table>
								</div>
					...
					<div  style="padding:20px;">
					    <div class="container" >
							<div class="c-content-title-3 c-title-md c-border-blue-2">
								<h3 class="c-font-blue-2 ">Pune Vipassana Samiti Donation-Field</h3>
							</div>
							<p style="margin-left:25px;">Pune Vipassana Samiti by post or email on given email id.</p>
							<div style="margin-left:35px; line-height:35px;">
								<div class="row" data-auto-height="true">
									<div class=" " style="padding:0px" data-height="height">
										<table style="line-height: 40px; " class="table" >
											<div class="row">
												<div class="col-md-2" style="width:130px;">
													<span class="c-content-title-3 c-title-md  c-theme-on-hover c-font-bold" style="border:none;padding-left: 0px;"><i style="" class="icon-envelope  c-font-blue-2">&nbsp;</i> Mail ID&nbsp;:</span>
												</div>
												<div  class="col-md-9">
													<span ><a style="color: #5c6873;" class="c-theme-on-hover" href="mailto:treasurer@punna.dhamma.org "><u>treasurer@punna.dhamma.org</u></a></span>
												</div>
											</div>
											<div  class="row">
												<div class="col-md-2"style="width:130px;">
													<span class="c-content-title-3 c-title-md  c-theme-on-hover c-font-bold" style="border:none;padding-left: 0px;"><i style="" class="fa fa-check-square-o  c-font-blue-2">&nbsp;&nbsp;</i>Fields&nbsp;:</span>
												</div>
												<div class="col-md-9">
													<ul class="c-content-list-1 c-theme c-separator-dot"style="margin:0px;">
														<li>Donor's Name</li>
														<li>Amount</li>
														<li>Full Contact Address</li>
														<li>Cheque Number/Online Transaction Number</li>
														<li>Bank Name</li>
														<li>Cheque Issuing Date/Online Transaction Date</li>
														<li>PAN Number</li>
													</ul>
												</div>
											</div>
							...
							<p class="c-font-bold " style="margin-left:25px;">The donation receipt shall be sent to you by postal mail or email.</p>
	                    </div> 
	                </div>
		        </div>
		    </div><br>
