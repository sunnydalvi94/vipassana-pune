					...
					<div class="portlet light"style="padding: 15px 30px 15px 30px;">
						<div class="portlet-title">
							<div class="caption font-blue">
                                ...
                                <span class="caption-subject bold uppercase">Add One Day Course</span>
                            </div>
						</div>
						<div class="portlet-body form">
							<form action="one_day_course" id="one_day_course" data-apikey="<?php echo (isset($keydata->key) && !empty($keydata->key))?$keydata->key:''; ?>" data-redirect="one-day-course" class="horizontal-form" method="post" enctype="multipart/form-data">
							  	<div class="form-body">
								    <div class="row"> 
								    	<div class="col-md-8">
								    		<div class="row">
								    			<div class="col-md-4">
										    		<div class="form-group">
										    			...
										    			<div class="input-icon right"><i class="fa"></i>
										    				...
										    				name="one_day_course_area" value="<?php echo(isset($one_day_course_data->one_day_course_area) && !empty($one_day_course_data->one_day_course_area))?$one_day_course_data->one_day_course_area:'';?>"
								    			...
								    			<div class="col-md-4">
										    		<div class="form-group">
										    			...
										    			<div class="input-icon right"><i class="fa"></i>
										    				<input type="text" class="form-control" 
										    				name="day" value="<?php echo(isset($one_day_course_data->day) && !empty($one_day_course_data->day))?$one_day_course_data->day:'';?>"
										    				placeholder="Day"required  minlength="4" maxlength="150">
										    			</div>
										    		</div>
								    			</div>
								    			<div class="col-md-4">
										    		<div class="form-group">
										    			...
										    			<div class="input-icon right"><i class="fa"></i>
										    				<input type="text" class="form-control" 
										    				name="time" value="<?php echo(isset($one_day_course_data->time) && !empty($one_day_course_data->time))?$one_day_course_data->time:'';?>"
								    			...
								    			<div class="col-md-12">
										    		<div class="form-group">
										    			...
										    			<div class="input-icon right"><i class="fa"></i>
										    				...
										    				name="one_day_course_address" rows="5" 
										    				placeholder="Adress"required minlength="4" maxlength="250"><?php echo(isset($one_day_course_data->one_day_course_address) && !empty($one_day_course_data->one_day_course_address))?$one_day_course_data->one_day_course_address:'';?></textarea>
										    			</div>
										    		</div>
								    			</div>
								    			<div class="col-md-6">
										    		<div class="form-group">
										    			...
										    			<div class="input-icon right"><i class="fa"></i>
										    				<input type="text" class="form-control" 
										    				name="contact_no" value="<?php echo(isset($one_day_course_data->contact_no) && !empty($one_day_course_data->contact_no))?$one_day_course_data->contact_no:'';?>"
								    			...
								    			<div class="col-md-6">
										    		<div class="form-group">
										    			...
										    			<div class="input-icon right"><i class="fa"></i>
										    				<input type="text" class="form-control" 
										    				name="google_map" value="<?php echo(isset($one_day_course_data->google_map) && !empty($one_day_course_data->google_map))?$one_day_course_data->google_map:'';?>"
								    	...
								    	<div class="col-md-4 text-center">
											<div class="form-group">
										        ...
										        <div class="uploaded_image" style="padding-bottom: 10px !important;">
										            <img src="<?php echo base_url(); ?>uploads/one_day_course_images/<?php echo(isset($one_day_course_data->one_day_course_image) && !empty($one_day_course_data->one_day_course_image))?$one_day_course_data->one_day_course_image:'default.png';?>" style="height: 150px; width: 200px;" class="img-thumbnail"/>
										        </div>
										        <input type="file" name="file" id="file" class="upload_image" data-url="upload_one_day_course_image">
										        <label for="file" class="upload_button" /><?php echo(isset($one_day_course_data->one_day_course_image) && !empty($one_day_course_data->one_day_course_image))?'Change':'Select File';?></label>
										        <input type="hidden" name="one_day_course_image" class="file_name" value="<?php echo(isset($one_day_course_data->one_day_course_image) && !empty($one_day_course_data->one_day_course_image))?$one_day_course_data->one_day_course_image:'';?>">
						    	...
						    	<input type="hidden" name="one_day_course_id" value="<?php echo(isset($one_day_course_data->one_day_course_id) && !empty($one_day_course_data->one_day_course_id))?$one_day_course_data->one_day_course_id:'';?>">
							  	<div class="form-actions ">
								  <a href="<?php echo base_url();?>one-day-course"class="btn btn-primary"type="button" 
								  	><i class=" icon-arrow-left "></i> Back</a>
								  	<div class="pull-right">	
									  	<button type="reset" class="btn btn-danger"> <i class="icon-close"></i> Clear </button>
										<button type="submit" class="btn btn-primary common_save" data-pk="one_day_course_id" rel="<?php echo(isset($one_day_course_data->one_day_course_id) && !empty($one_day_course_data->one_day_course_id))?$one_day_course_data->one_day_course_id:'';?>"> <i class="icon-check"></i> <?php echo(isset($one_day_course_data->one_day_course_id) && !empty($one_day_course_data->one_day_course_id))?'Update':'Submit';?> </button> 
							    	</div>
							    </div>	
