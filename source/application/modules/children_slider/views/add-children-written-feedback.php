					...
					<div class="col-md-12">
						<div class="portlet light">
							...
							<div class="portlet-body form">
								<form action="children-slider" id="children-slider" data-apikey="<?php echo (isset($keydata->key) && !empty($keydata->key))?$keydata->key:''; ?>" data-redirect="children-written-feedback-list" class="horizontal-form" method="post" enctype="multipart/form-data">
								  	<div class="form-body">
									    <div class="row"> 
									    	<div class="col-md-7">
									    		<div class="form-group">
									    			...
									    			<div class="input-icon right"><i class="fa"></i>
									    				...
									    				name="slider_name" value="<?php echo(isset($children_written_feedback_data->slider_name) && !empty($children_written_feedback_data->slider_name))?$children_written_feedback_data->slider_name:'';?>"
									    		...
									    		<div class="form-group">
									    			...
									    			<div class="input-icon right"><i class="fa"></i>
									    				<input type="text" class="form-control" 
									    				name="slider_description" value="<?php echo(isset($children_written_feedback_data->slider_description) && !empty($children_written_feedback_data->slider_description))?$children_written_feedback_data->slider_description:'';?>"
									    	...
									    	<div class="col-md-5 text-center">
												<div class="form-group">
											        ...
											        <div class="uploaded_image" style="padding-bottom: 10px !important;">
											            <img src="<?php echo base_url(); ?>uploads/children_slider_images/<?php echo(isset($children_written_feedback_data->image) && !empty($children_written_feedback_data->image))?$children_written_feedback_data->image:'default.png';?>" style="height: 150px; width: 200px;" class="img-thumbnail"/>
											        </div>
											        <input type="file" name="file" id="file" class="upload_image" data-url="upload_children_slider_image">
											        <label for="file" class="upload_button" /><?php echo(isset($children_written_feedback_data->image) && !empty($children_written_feedback_data->image))?'Change':'Select File';?></label>
											        <input type="hidden" name="image" class="file_name" value="<?php echo(isset($children_written_feedback_data->image) && !empty($children_written_feedback_data->image))?$children_written_feedback_data->image:'';?>">
							    	...
							    	<input type="hidden" name="children_slider_id" value="<?php echo(isset($children_written_feedback_data->children_slider_id) && !empty($children_written_feedback_data->children_slider_id))?$children_written_feedback_data->children_slider_id:'';?>">
								  	<div class="form-actions ">
									  <a href="<?php echo base_url();?>children-written-feedback-list"class="btn btn-primary"type="button" 
									  	><i class=" icon-arrow-left "></i> Previous</a>
									  	<div class="pull-right">	
										  	<button type="reset" class="btn btn-danger"> <i class="icon-close"></i> Clear </button>
											<button type="submit" class="btn btn-success common_save" data-pk="children_slider_id" rel="<?php echo(isset($children_written_feedback_data->children_slider_id) && !empty($children_written_feedback_data->children_slider_id))?$children_written_feedback_data->children_slider_id:'';?>"> <i class="icon-check"></i> <?php echo(isset($children_written_feedback_data->children_slider_id) && !empty($children_written_feedback_data->children_slider_id))?'Update':'Submit';?> </button> 
								    	</div>
								    </div>	
