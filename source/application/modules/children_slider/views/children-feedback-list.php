                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-blue">
                                        ...
                                        <span class="caption-subject bold uppercase">Children Feedback</span>
                                    </div>
                                    <div class="actions tools">
                                        <a href="<?php echo base_url();?>add-children-feedback" class="btn blue btn-sm" style="height:27px ;"><i class="icon-plus"></i>  New</a>
                                    </div>
                                </div>
                                <div class="portlet-body form">
                                    <table class="table table-striped table-bordered table-hover masterTable">
                                        ...
                                        <tbody>
                                         <?php if(isset($children_feedback_data) && !empty($children_feedback_data))
                                            {$i=1;
                                                foreach ($children_feedback_data as $key) 
                                                {  ?>
                                            <tr>
                                                ...
                                                <td style='text-align: center;' class="tbl_action" data-col="children_slider_id">
                                                        ...
                                                        <?php } ?>
                                                        <a href="<?php echo base_url(); ?>add-children-feedback/<?php echo(isset($key->children_slider_id) && !empty($key->children_slider_id))?$key->children_slider_id:'';?>" class="label bg-green-jungle tooltips " title="Edit Record"><i class="icon-pencil"></i></a>
